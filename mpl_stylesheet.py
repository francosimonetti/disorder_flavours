...
def banskt_presentation(black = '#333333', linewidth = 2, ticksize = 8, fontsize = 28, padding = 10, fontfamily = 'latex', colors = 'banskt', dpi = 300):
    ...
    if fontfamily == 'latex':
        matplotlib.rcParams['text.latex.preamble'] = r'\usepackage[sfdefault,scaled=.85, lining]{FiraSans} \usepackage[cmintegrals]{newtxsf} \usepackage{microtype}'
        matplotlib.rcParams['text.usetex'] = True
    elif fontfamily == 'latex-clearsans':
        matplotlib.rcParams['text.latex.preamble'] = r'\usepackage[scaled=.86]{ClearSans} \usepackage[libertine]{newtxmath} \usepackage{microtype}'
    elif fontfamily == 'mono':
